...
public class EditPlaylistPage extends VBox implements Page {
    ...
    @FXML private ListView<AudioClipView> _songListView;
    ...
    private void generate() {
        final List<AudioClipView> list = new ArrayList<>();
        _playlistData.forEach(songID -> {
            final AudioClipView songNode = new AudioClipView(songID, "Song", "Artist");
            list.add(songNode);
        });

        final ObservableList<AudioClipView> items = FXCollections.observableList(list);
    ...
    private void onAddFileButtonClicked(ActionEvent e) {
        ...
        final AudioClipView songNode = new AudioClipView(UUID.randomUUID(), file.getName(), "");
    ...
    private void onAddSongButtonClicked(ActionEvent e) {
        final AudioClipView songNode = new AudioClipView(UUID.randomUUID(), "Song", "");
        _songListView.getItems().add(songNode);
    }
